// src/components/WorkspaceFilterSettings.jsx
//
// Ship 3 — Workspace filter section for Settings panel
//
// Drop this anywhere inside the existing Settings panel:
//   import WorkspaceFilterSettings from './WorkspaceFilterSettings';
//   ...
//   <WorkspaceFilterSettings />
//
// Shows two rows: AVS Solution HT and AVS Recharge. Each has a date
// picker. Setting a date confirms via modal. Removing confirms via modal.
// The setting persists in business.workspaceFilters and is applied across
// all modules via the useWorkspaceFilter hook.
//
...
export default function WorkspaceFilterSettings() {
  ...
  return (
    <div className="space-y-2">
      <div className="text-[11px] uppercase tracking-wider text-muted font-medium px-1">
        Workspace data
      </div>
